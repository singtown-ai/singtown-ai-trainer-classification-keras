...
```
# test
export SINGTOWN_AI_MOCK_TASK_URL="../mock-task.json"
export SINGTOWN_AI_MOCK_DATASET_URL="../classification-20.json"
uv run main.py
```
...
export SINGTOWN_AI_MOCK_TASK_URL="../classification-20.json"
export SINGTOWN_AI_MOCK_DATASET_URL="../classification-20.json"
uv run main.py
```
